...
class CommandLineInterface(object):
    ...
    commands = {
        ...
        'ginit' : 'Extract, initialize, auto-translate and compile from current folder',
        'gupdate' : 'Extract, update, auto-translate and compile from current folder'
    }
